...
class Paso1():
	...
	def __init__(self):
		...
		md=gtk.MessageDialog(parent=None, flags=0, type=gtk.MESSAGE_WARNING, buttons=gtk.BUTTONS_OK, message_format="Para construir el nuevo sabor debe tener una conexión a Internet, de lo contario el sabor no se construirá")
		md.run()
		md.destroy()
